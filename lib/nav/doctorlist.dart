...
import 'package:groupuiproject/model/model_data.dart';
import 'package:groupuiproject/nav/list_buider.dart';

class HomePageDimo extends StatelessWidget {
  HomePageDimo({Key? key}) : super(key: key);
  var ListUserData = ModelData.doctorData();

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(backgroundColor: Colors.grey.shade400,
        body: Container(
